		...
		<AlertDialog open={isOpen}>
			<AlertDialogContent>
				<AlertDialogHeader>
					...
					<div className="flex flex-row items-center justify-between border-2 border-solid border-red-500">
						<p>
							Signature R: {signature[0].substring(0, 10)}...
							{signature[0].substring(signature[0].length - 10)}
						</p>
						<FaPaste size={25} className="mr-2" />
					</div>
					<div className="flex flex-row items-center justify-between border-2 border-solid border-red-500">
						<p>
							Signature S: {signature[1].substring(0, 10)}...
							{signature[1].substring(signature[1].length - 10)}
						</p>
						<FaPaste size={25} className="mr-2" />
					</div>
				</AlertDialogHeader>
